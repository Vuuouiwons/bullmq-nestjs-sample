...
const dummy_processor_1 = require("./dummy.processor");
...
exports.DummyModule = DummyModule = __decorate([
    (0, common_1.Module)({
        controllers: [
            dummy_controller_1.DummyController
        ],
        providers: [
            dummy_service_1.DummyService,
            dummy_processor_1.Queue1Processor,
            dummy_processor_1.Queue2Processor,
            dummy_processor_1.Queue3Processor
        ],
    })
], DummyModule);
